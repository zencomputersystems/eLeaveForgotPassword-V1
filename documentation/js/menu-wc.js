...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">eLeaveForgotPassword documentation</a>
                </li>
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-ae9d1db840c864d3df5d8e7069576822"' : 'data-target="#xs-components-links-module-AppModule-ae9d1db840c864d3df5d8e7069576822"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-ae9d1db840c864d3df5d8e7069576822"' :
                                            'id="xs-components-links-module-AppModule-ae9d1db840c864d3df5d8e7069576822"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/ResetPasswordPageModule.html" data-type="entity-link">ResetPasswordPageModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-ResetPasswordPageModule-8614ed7fb2e4f04aa601bc06f0a7720d"' : 'data-target="#xs-components-links-module-ResetPasswordPageModule-8614ed7fb2e4f04aa601bc06f0a7720d"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-ResetPasswordPageModule-8614ed7fb2e4f04aa601bc06f0a7720d"' :
                                            'id="xs-components-links-module-ResetPasswordPageModule-8614ed7fb2e4f04aa601bc06f0a7720d"' }>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/InfoPopupService.html" data-type="entity-link">InfoPopupService</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
